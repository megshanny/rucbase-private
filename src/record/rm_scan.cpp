...
void RmScan::next() {
    ...
    {
        RmPageHandle temp = file_handle_->fetch_page_handle(rid_.page_no);
        rid_.slot_no = Bitmap::next_bit(true,temp.bitmap,file_handle_->file_hdr_.num_records_per_page,rid_.slot_no);
